...
var esProxy = require('./es-proxy.js');
...
module.exports = function (server){
  ...
  server.get ({ cache: true, path : '/api/es/:index/:type/:action' }, esProxy.get);
  server.post ({ cache: true, path : '/api/es/:index/:type/:action' }, esProxy.post);
